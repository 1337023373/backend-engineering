...
-   [六、MyBatis高级扩展](#六MyBatis高级扩展)
    ...
    -   [3. 逆向工程和MybatisX插件](#3-逆向工程和MybatisX插件)
        ...
        -   [3.1 逆向工程](#31-逆向工程)
        -   [3.2 逆向工程插件MyBatisX使用](#32-逆向工程插件MyBatisX使用)
...
2.  使用 IntelliJ IDEA连接数据库
    -   连接数据库
        ...
        ![](image/image_D9iLUl3C_O.png)
    -   填写信息

        ![](image/image_PTAm1WJDDh.png)
    -   展示库表

        ![](image/image_0klK5C28iC.png)
    -   逆向工程使用

        ![](image/image_Run_-MLT30.png)

        ![](image/image_z0l4fytpTF.png)

        ![](image/image_ZQwtbfzADM.png)
3.  查看生成结果

    ![](image/image_amASQRCwGP.png)
4.  逆向工程案例使用
...
![](http://heavy_code_industry.gitee.io/code_heavy_industry/assets/img/img014.4d03b574.png)
